...
namespace TopCore.Framework.Search.Elastic.Model.SearchModel.Queries
{
    ...
    ///     query_string query, the simple_query_string query will never throw an exception, and
    ///     discards invalid parts of the query The simple_query_string supports the following
    ///     special characters:
    ...
    ///     * at the end of a term signifies a prefix query ( and ) signify precedence ~N after a
    ///       word signifies edit distance (fuzziness) ~N after a phrase signifies slop amount
    /// </summary>
