...
namespace Puppy.Web.Attributes
{
    ...
    /// </summary>
    /// <seealso cref="T:Puppy.Web.Attributes.HttpHeaderAttribute" />
    public class UserAgentHttpHeaderAttribute : HttpHeaderAttribute
    {
        ...
        ///     <see cref="T:Puppy.Web.Attributes.UserAgentHttpHeaderAttribute" /> class.
        /// </summary>
        public UserAgentHttpHeaderAttribute() : base(UserAgentHttpHeaderName)
        {
        }
            ...
            if (!StringValues.IsNullOrEmpty(headerValues))
            {
                var values = headerValues
                    ...
                    .Select(
                        x =>
                        {
                            var parsed = ProductInfoHeaderValue.TryParse(x, out var productInfo);
                            return new
                            {
                                Parsed = parsed,
