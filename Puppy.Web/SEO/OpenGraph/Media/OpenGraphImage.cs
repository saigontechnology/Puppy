...
{
    /// <summary>
    ///     An image which should represent your object within the graph. Use images that are at
    ///     least 1200 x 630 pixels for the best display on high resolution devices. At the minimum,
    ///     you should use images that are 600 x 315 pixels to display link page posts with larger
    ///     images. If your image is smaller than 600 x 315 pixels, it will still display in the link
    ///     page post, but the size will be much smaller. Try to keep your images as close to 1.91:1
    ///     aspect ratio as possible to display the full image in News Feed without any cropping. The
    ///     minimum size of an image is 200 x 200. If you try to use an image smaller than this you
    ...
    public class OpenGraphImage : OpenGraphSizedMedia
    {
        ...
        ///     Thrown if imageUrl is <c> null </c>.
        /// </exception>
        ...
        /// <param name="type">    
        ///     The MIME type of the media e.g. media/jpeg. This is optional if your media URL ends
        ///     with a file extension, otherwise it is recommended.
        /// </param>
        /// <exception cref="System.ArgumentNullException">
        ///     Thrown if <paramref name="imageUrl" /> is <c> null </c>.
        /// </exception>
