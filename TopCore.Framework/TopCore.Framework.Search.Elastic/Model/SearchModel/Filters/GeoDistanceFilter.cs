...
namespace TopCore.Framework.Search.Elastic.Model.SearchModel.Filters
{
    ...
    public class GeoDistanceFilter : IFilter
    {
        ...
        /// <param name="distance">
        ///     The radius of the circle centred on the specified location. Points which fall into this circle
        ///     are considered to be matches. The distance can be specified in various units. See the section called “Distance
        ///     Unitsedit”.
        /// </param>
        ...
        ///     Defaults to memory which will do in memory checks. Can also have values of indexed to use indexed value check (make
        ///     sure the geo_point type index lat lon in this case), or
