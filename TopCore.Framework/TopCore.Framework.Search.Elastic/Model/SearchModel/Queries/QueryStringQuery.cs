...
namespace TopCore.Framework.Search.Elastic.Model.SearchModel.Queries
{
    ...
    ///     http://www.elastic.org/guide/en/elastic/reference/current/query-dsl-query-string-query.html
    /// </summary>
    public class QueryStringQuery : IQuery
    {
        ...
        /// <summary>
        ///     default_field The default field for query terms if no prefix field is specified. Defaults to the
        ///     index.query.default_field index settings, which in turn defaults to _all. When not explicitly specifying the field
        ///     to search on in the query string syntax, the index.query. default_field
        ///     will be used to derive which field to search on. It defaults to _all field. So, if _all field is disabled, it might
        ///     make sense to change it to set a different default fie
        /// </summary>
        ...
        /// <summary>
        ///     analyze_wildcard By default, wildcards terms in a query string are not analyzed. By setting this value to true, a
        ///     best effort will be made to analyze those as well.
        /// </summary>
        ...
        /// <summary>
        ///     use_dis_max Should the queries be combined using dis_max (set it to true), or a bool query (set it to false).
        ///     Defaults to true.
        /// </summary>
