...
{
    /// <summary>
    ///     A filter that stems words using a Snowball-generated stemmer. The language parameter
    ///     controls the stemmer with the following available
    ///     values: Armenian, Basque, Catalan, Danish, Dutch, English, Finnish, French, German,
    ///             German2, Hungarian, Italian, Kp, Lovins, Norwegian, Porter, Portuguese, Romanian,
    ...
    public class SnowballTokenFilter : AnalysisFilterBase
    {
        ...
        ///     controls the stemmer with the following available
        ///     values: Armenian, Basque, Catalan, Danish, Dutch, English, Finnish, French, German,
        ///             German2, Hungarian, Italian, Kp, Lovins, Norwegian, Porter, Portuguese,
