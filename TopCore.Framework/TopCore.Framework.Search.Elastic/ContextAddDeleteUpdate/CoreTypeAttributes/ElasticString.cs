...
namespace TopCore.Framework.Search.Elastic.ContextAddDeleteUpdate.CoreTypeAttributes
{
    ...
    public class ElasticString : ElasticCoreTypes
    {
        ...
        /// <summary>
        ///     index Set to analyzed for the field to be indexed and searchable after being broken
        ///     down into token using an analyzer. not_analyzed means that its still searchable, but
        ///     does not go through any analysis process or broken down into tokens. no means that it
        ///     won’t be searchable at all (as an individual field; it may still be included in
        ///     _all). Setting to no disables include_in_all. Defaults to analyzed.
        /// </summary>
        ...
        /// <summary>
        ///     term_vector Possible values are no, yes, with_offsets, with_positions,
        ///     with_positions_offsets. Defaults to no.
        /// </summary>
        ...
        /// <summary>
        ///     norms: {enabled: value} Boolean value if norms should be enabled or not. Defaults to
        ///            true for analyzed fields, and to false for not_analyzed fields. See the
        ///            section about norms.
        /// </summary>
        ...
        ///            eager and lazy (default). It is possible to change the default value to eager
        ///            for all fields by configuring the index setting index.norms.loading to eager.
        /// </summary>
        ...
        /// <summary>
        ///     index_options Allows to set the indexing options, possible values are docs (only doc
        ///     numbers are indexed), freqs (doc numbers and term frequencies), and positions (doc
        ///     numbers, term frequencies and positions). Defaults to positions for analyzed fields,
        ///     and to docs for not_analyzed fields. It is also possible to set it to offsets (doc
        ///     numbers, term frequencies, positions and offsets).
        /// </summary>
        ...
        /// <summary>
        ///     analyzer The analyzer used to analyze the text contents when analyzed during indexing
        ///     and when searching using a query string. Defaults to the globally configured analyzer.
        /// </summary>
        ...
        /// <summary>
        ///     ignore_above The analyzer will ignore strings larger than this size. Useful for
        ///     generic not_analyzed fields that should ignore long text.
        /// </summary>
        ...
        /// <summary>
        ///     position_offset_gap Position increment gap between field instances with the same
        ///     field name. Defaults to 0.
        /// </summary>
