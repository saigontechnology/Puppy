...
namespace TopCore.Framework.Search.Elastic.Model.SearchModel.Aggregations
{
    ...
    ///     aggregator will often be used in conjunction with other
    ///     field data bucket aggregators (such as ranges) to return information for all the documents that could not be placed
