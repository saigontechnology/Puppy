...
namespace TopCore.Framework.Search.Elastic
{
        ...
        where TOld : class
    {
        ...
        /// <summary>
        ///     Scan ans scroll settings for the reindex. You should keep this small, otherwise the response request will be too
        ///     larger. Default is 5 seconds with a size of 500 documents pro shard.
        /// </summary>
        public ScanAndScrollConfiguration ScanAndScrollConfiguration =
            new ScanAndScrollConfiguration(new TimeUnitSecond(5), 500);

        /// <summary>
        ///     Reindex constructor. The class reuires a index and a type for the old index and also the new index. The old index
        ///     can then be converteds or reindexed to the new index.
        /// </summary>
        ...
        /// <summary>
        ///     Resets the alias from the old index to the new index. Assumes that a alias is used for the old indeex. This way,
        ///     reindex can be done live.
        /// </summary>
