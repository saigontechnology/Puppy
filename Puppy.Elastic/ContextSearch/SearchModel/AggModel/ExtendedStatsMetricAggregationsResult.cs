...
namespace Puppy.Elastic.ContextSearch.SearchModel.AggModel
{
    public class ExtendedStatsMetricAggregationsResult : AggregationResult<ExtendedStatsMetricAggregationsResult>
    {
        ...
        /// <summary>
        ///     support from version 1.4.3 The standard deviation and its bounds are displayed by
        ///     default, but they are not always applicable to all data-sets. Your data must be
        ///     normally distributed for the metrics to make sense. The statistics behind standard
        ///     deviations assumes normally distributed data, so if your data is skewed heavily left
        ///     or right, the value returned will be misleading.
        /// </summary>
