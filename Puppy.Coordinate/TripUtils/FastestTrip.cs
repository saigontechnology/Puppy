...
//         <Created> 22/01/2018 10:12:39 PM </Created>
//         <Key> 7824e834-6a6f-4988-b030-32a76defa63b </Key>
//     </File>
//     <Summary>
//         FastestTrip.cs
//     </Summary>
...
namespace Puppy.Coordinate.TripUtils
{
    ...
    /// </summary>
    public class FastestTrip
    {
        public enum FastestTripMode
        {
            AtoZ = 1,
            RoundTrip = 2
        }
        ...
        private DistanceDurationMatrixModel DistanceDurationDurationMatrix { get; }
        ...
        {
            var duration = DistanceDurationDurationMatrix.DurationMatrix[index1, index2];
        ...
        {
            var distance = DistanceDurationDurationMatrix.DistanceMatrix[index1, index2];
        ...
        private double GetMinDistance(int index)
        {
            ...
            {
                var distance = DistanceDurationDurationMatrix.DistanceMatrix[index, i];
        ...
        private void BackTrackingVisit(int step)
        {
            ...
            {
                if (_tripMode == FastestTripMode.RoundTrip)
                {
