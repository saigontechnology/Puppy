...
namespace TopCore.Framework.Search.Elastic.ContextSearch.SearchModel.AggModel
{
    ...
    ///     indices and the document types you’re searching on, but is not influenced by the search query itself. Note Global
    ///     aggregators can only be placed as top level aggregators (it
