...
namespace Puppy.Search.Elastic.Model.SearchModel.Filters
{
    ...
    public class GeoDistanceFilter : IFilter
    {
        ...
        /// <param name="distance">
        ///     The radius of the circle centred on the specified location. Points which fall into
        ///     this circle are considered to be matches. The distance can be specified in various
        ///     units. See the section called “Distance Unitsedit”.
        /// </param>
        ...
        /// <summary>
        ///     distance_type How to compute the distance. Can either be sloppy_arc (default), arc
        ///     (slighly more precise but significantly
        ...
        /// <summary>
        ///     optimize_bbox Whether to use the optimization of first running a bounding box check
        ///     before the distance check. Defaults to memory which will do in memory checks. Can
        ///     also have values of indexed to use indexed value check (make sure the geo_point type
        ///     index lat lon in this case), or none which disables bounding box optimization.
        /// </summary>
