...
namespace TopCore.Framework.Search.Elastic.Model.SearchModel.Queries
{
    ...
    ///     The span near query maps to Lucene SpanNearQuery. The clauses element is a list of one or
    ///     more other span type queries and the slop controls the maximum number of intervening
