...
//     <File>
//         <Name> TwitterPlayer.cs </Name>
//         <Created> 07/06/2017 10:18:19 PM </Created>
//         <Key> ea98812c-1483-4993-a2e9-1f321a9ba674 </Key>
//     </File>
//     <Summary>
//         TwitterPlayer.cs
//     </Summary>
...
{
    /// <summary>
    ///     A video used in a Twitter card. If the iframe is wider than 435px, the iframe player will
    ...
    public class TwitterPlayer
    {
        ...
        {
            PlayerUrl = playerUrl ?? throw new ArgumentNullException(nameof(playerUrl));
        ...
        ///     content_type values are those defined in RFC 4337 (MIME Type Registration for MP4).
        /// </param>
        /// <param name="streamUrl">        
        ///     The URL to a raw stream that will be rendered in Twitter’s mobile applications
        ///     directly. If provided, the stream must be delivered in the MPEG-4 container format
        ///     (the.mp4 extension). The container can store a mix of audio and video with the
        ///     following codecs: Video: H.264, Baseline Profile(BP), Level 3.0, up to 640 x 480 at
        ...
        /// <summary>
        ///     Gets the URL to an iframe player. This must be a HTTPS URL which does not generate
        ///     active mixed content warnings in a web browser.
        /// </summary>
        /// <value> The HTTPS URL to the iframe player. </value>
        public string PlayerUrl { get; }

        /// <summary>
        ///     Gets or sets the MIME type/subtype combination that describes the content contained
        ///     in twitter:player:stream. Takes the form specified in RFC 6381. Currently supported
        ///     content_type values are those defined in RFC 4337 (MIME Type Registration for MP4).
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the URL to a raw stream that will be rendered in Twitter’s mobile
        ///     applications directly. If provided, the stream must be delivered in the MPEG-4
        ///     container format (the.mp4 extension). The container can store a mix of audio and
        ///     video with the following codecs: Video: H.264, Baseline Profile(BP), Level 3.0, up to
        ///     640 x 480 at 30 fps. Audio: AAC, Low Complexity Profile(LC).
        /// </summary>
        /// <value>
        ///     The URL to a raw stream that will be rendered in Twitter’s mobile applications directly..
        /// </value>
