...
{
	/// <summary>
	///     A special single bucket aggregation that enables aggregating from buckets on parent document types to buckets on child documents. This aggregation relies on the _parent field in the mapping. This aggregation has a single option: type - The what child type the buckets in the parent space
	///     should be mapped to.
	/// </summary>
