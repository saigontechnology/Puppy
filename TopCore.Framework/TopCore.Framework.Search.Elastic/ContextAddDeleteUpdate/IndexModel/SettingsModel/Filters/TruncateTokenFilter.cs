...
namespace TopCore.Framework.Search.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel.Filters
{
    public class TruncateTokenFilter : AnalysisFilterBase
    {
        ...
        /// <summary>
        ///     The truncate token filter can be used to truncate tokens into a specific length. This
        ///     can come in handy with keyword (single token) based mapped fields that are used for
        ///     sorting in order to reduce memory usage.
        /// </summary>
        ...
        /// <summary>
        ///     length It accepts a length parameter which control the number of characters to
        ///     truncate to, defaults to 10.
        /// </summary>
        public int Length
        {
            get => _length;
