...
using Puppy.Search.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel.Filters;

namespace Puppy.Search.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel
{
    // "filter" : { "blocks_filter" : { "type" : "word_delimiter", "preserve_original": "true" },
    // "shingle":{ "type":"shingle", "max_shingle_size":5, "min_shingle_size":2,
    // "output_unigrams":"true" }, "filter_stop":{ "type":"stop",
