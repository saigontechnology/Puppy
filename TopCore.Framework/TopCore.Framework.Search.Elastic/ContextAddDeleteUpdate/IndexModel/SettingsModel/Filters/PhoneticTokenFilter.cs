...
namespace TopCore.Framework.Search.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel.Filters
{
    public class PhoneticTokenFilter : AnalysisFilterBase
    {
        ...
        /// <summary>
        ///   https://github.com/elastic/elastic-analysis-phonetic A phonetic token filter that can be configured with different encoder types:
        ///   metaphone, doublemetaphone, soundex, refinedsoundex, caverphone1, caverphone2, cologne, nysiis, koelnerphonetik, haasephonetik,
        ///   beidermorse The replace parameter (defaults to true) controls if the token processed should be replaced with the encoded one (set it to
        ...
        /// <summary>
        ///   A phonetic token filter that can be configured with different encoder types: metaphone, doublemetaphone, soundex, refinedsoundex,
        ///   caverphone1, caverphone2, cologne, nysiis, koelnerphonetik, haasephonetik, beidermorse
        /// </summary>
        ...
        /// <summary>
        ///   The replace parameter (defaults to true) controls if the token processed should be replaced with the encoded one (set it to true), or
        ///   added (set it to false).
        /// </summary>
        public bool Replace
        {
            get => _replace;
