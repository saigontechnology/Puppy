...
namespace TopCore.Framework.Search.Elastic.ContextAddDeleteUpdate.IndexModel
{
    public class OptimizeParameters
    {
        ...
        /// <summary>
        ///   max_num_segments The number of segments to optimize to. To fully optimize the index, set it to 1. Defaults to simply checking if a merge
        ///   needs to execute, and if so, executes it.
        /// </summary>
        ...
        /// <summary>
        ///   only_expunge_deletes Should the optimize process only expunge segments with deletes in it. In Lucene, a document is not deleted from a
        ///   segment, just marked as deleted. During a merge process of segments, a new segment is created that does not have those deletes. This flag
        ///   allows to only merge segments that have deletes. Defaults to false. Note that this won’t override the
        ...
        /// <summary>
        ///   wait_for_merge Should the request wait for the merge to end. Defaults to true. Note, a merge can potentially be a very heavy operation,
