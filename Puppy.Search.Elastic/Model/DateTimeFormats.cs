namespace Puppy.Search.Elastic.Model
{
    ...
    {
        /// <summary>
        ///     A basic formatter for a full date as four digit year, two digit month of year, and
        ///     two digit day of month (yyyyMMdd).
        /// </summary>
        ...
        /// <summary>
        ///     A formatter for a full ordinal date and time without millis, using a four digit year
        ...
        /// <summary>
        ///     A basic formatter for a two digit hour of day, two digit minute of hour, two digit
        ...
        /// <summary>
        ///     A basic formatter for a two digit hour of day, two digit minute of hour, two digit
        ///     second of minute, three digit millis, and time zone off set prefixed by T ('T’HHmmss.SSSZ).
        /// </summary>
        ...
        /// <summary>
        ///     A formatter for a full date as four digit year, two digit month of year, and two
        ...
        /// <summary>
        ///     A formatter that combines a full date, two digit hour of day, two digit minute of
        ...
        /// <summary>
        ///     A formatter that combines a full date, two digit hour of day, two digit minute of
        ///     hour, two digit second of minute, and three digit fraction of second (yyyy-MM-dd’T'HH:mm:ss.SSS).
        /// </summary>
        ...
        /// <summary>
        ///     A formatter for a two digit hour of day, two digit minute of hour, and two digit
        ///     second of minute.
        /// </summary>
        public const string HourMinuteSecond = "hour_minute_second";

        /// <summary>
        ///     A formatter for a two digit hour of day, two digit minute of hour, two digit second
        ///     of minute, and three digit fraction of second (HH:mm:ss.SSS).
        /// </summary>
        ...
        /// <summary>
        ///     A formatter for a two digit hour of day, two digit minute of hour, two digit second
        ///     of minute, three digit fraction of second, and time zone offset (HH:mm:ss.SSSZZ).
        /// </summary>
        public const string Time = "time";

        /// <summary>
        ///     A formatter for a two digit hour of day, two digit minute of hour, two digit second
        ///     of minute, and time zone offset (HH:mm:ssZZ).
        /// </summary>
        public const string TimeNoMillis = "time_no_millis";

        /// <summary>
        ///     A formatter for a two digit hour of day, two digit minute of hour, two digit second
        ///     of minute, three digit fraction of second, and time zone offset prefixed by T ('T’HH:mm:ss.SSSZZ).
        /// </summary>
        public const string TTime = "t_time";

        /// <summary>
        ///     A formatter for a two digit hour of day, two digit minute of hour, two digit second
        ///     of minute, and time zone offset prefixed by T ('T’HH:mm:ssZZ).
        /// </summary>
        public const string TTimeNoMillis = "t_time_no_millis";

        /// <summary>
        ///     A formatter for a full date as four digit weekyear, two digit week of weekyear, and
        ///     one digit day of week (xxxx-'W’ww-e).
        /// </summary>
        ...
        /// <summary>
        ///     A formatter that combines a full weekyear date and time without millis, separated by
        ///     a T (xxxx-'W’ww-e’T'HH:mm:ssZZ).
        /// </summary>
        ...
        /// <summary>
        ///     A formatter for a four digit weekyear, two digit week of weekyear, and one digit day
        ///     of week.
        /// </summary>
