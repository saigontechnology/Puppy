...
namespace Puppy.Elastic.ContextWarmers
{
    internal class ElasticContextWarmer
    {
        ...
        public ElasticContextWarmer(ITraceProvider traceProvider, CancellationTokenSource cancellationTokenSource,
        ...
        public async Task<ResultDetails<bool>> SendWarmerDeleteCommandAsync(string warmerName, string index)
        {
            ...
            _traceProvider.Trace(TraceEventType.Error,
                string.Format("ElasticContextWarmer: Cound Not Execute Warmer Delete {0}", warmerName));
            throw new ElasticException(string.Format("ElasticContextWarmer: Cound Not Execute Warmer Delete  {0}",
                warmerName));
        }
    }
}