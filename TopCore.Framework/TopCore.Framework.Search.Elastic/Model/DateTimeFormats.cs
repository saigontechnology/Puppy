namespace TopCore.Framework.Search.Elastic.Model
{
    public class DateTimeFormats
    {
        ...
        /// <summary>
        ///   A basic formatter for a two digit hour of day, two digit minute of hour, two digit second of minute, three digit millis, and time zone
        ///   offset (HHmmss.SSSZ).
        /// </summary>
        ...
        /// <summary>
        ///   A basic formatter for a two digit hour of day, two digit minute of hour, two digit second of minute, three digit millis, and time zone
        ///   off set prefixed by T ('T’HHmmss.SSSZ).
        /// </summary>
        ...
        /// <summary>
        ///   A formatter that combines a full date, two digit hour of day, two digit minute of hour, two digit second of minute, and three digit
        ...
        /// <summary>
        ///   A formatter for a two digit hour of day, two digit minute of hour, two digit second of minute, three digit fraction of second, and time
        ///   zone offset (HH:mm:ss.SSSZZ).
        /// </summary>
        ...
        /// <summary>
        ///   A formatter for a two digit hour of day, two digit minute of hour, two digit second of minute, three digit fraction of second, and time
        ///   zone offset prefixed by T ('T’HH:mm:ss.SSSZZ).
        /// </summary>
