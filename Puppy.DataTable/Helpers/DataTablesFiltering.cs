...
namespace Puppy.DataTable.Helpers
{
    ...
    {
        public IQueryable<T> ApplyFiltersAndSort<T>(DataTableParamModel dtParameters, IQueryable<T> data, DataTablesPropertyInfo[] columns)
        {
        ...
        private static DataTablesPropertyInfo FindColumn(DataTableParamModel dtParameters, DataTablesPropertyInfo[] columns, int i)
        {
