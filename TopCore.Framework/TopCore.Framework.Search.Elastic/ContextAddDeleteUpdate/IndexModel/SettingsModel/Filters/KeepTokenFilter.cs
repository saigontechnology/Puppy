...
namespace TopCore.Framework.Search.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel.Filters
{
    public class KeepTokenFilter : AnalysisFilterBase
    {
        ...
        /// <summary>
        ///   A token filter of type keep that only keeps tokens with text contained in a predefined set of words. The set of words can be defined in
        ///   the settings or loaded from a text file containing one word per line.
        /// </summary>
