...
namespace TopCore.Framework.Search.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel.Tokenizers
{
    public abstract class BaseNGramTokenizer : AnalysisTokenizerBase
    {
        ...
        /// <summary>
        ///     token_chars Characters classes to keep in the tokens, Elastic will split on
        ///     characters that don’t belong to any of these classes. [] (Keep all characters)
        ///     token_chars accepts the following character classes: letter for example a, b, ï or 京
        ///     digit for example 3 or 7 whitespace for example " " or "\n" punctuation for example !
        ///     or " symbol for example $ or √
        /// </summary>
