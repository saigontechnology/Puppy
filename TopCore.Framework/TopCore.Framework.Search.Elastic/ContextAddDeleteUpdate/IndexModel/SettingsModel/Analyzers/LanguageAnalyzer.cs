...
namespace TopCore.Framework.Search.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel.Analyzers
{
    public class LanguageAnalyzer : BaseStopAnalyzer
    {
        ...
        ///     basque, brazilian, bulgarian, catalan, chinese, cjk, czech, danish, dutch, english, finnish, french, galician,
        ///     german, greek, hindi, hungarian, indonesian, irish,
        ///     italian, latvian, norwegian, persian, portuguese, romanian, russian, sorani, spanish, swedish, turkish, thai.
        ///     Configuring language analyzersedit Stopwordsedit All analyzers support setting custom stopwords either internally
        ///     in the config, or by using an external stopwords file by
        ///     setting stopwords_path. The following analyzers support setting custom stem_exclusion list: arabic, armenian,
        ///     basque, catalan, bulgarian, catalan, czech, finnish, dutch, english, finnish, french, galician, german, irish,
        ///     hindi, hungarian, indonesian, italian, latvian, norwegian,
        ...
        /// <summary>
        ///     Excluding words from stemmingedit The stem_exclusion parameter allows you to specify an array of lowercase words
        ///     that should not be stemmed. Internally, this functionality is implemented by adding the keyword_marker token filter
