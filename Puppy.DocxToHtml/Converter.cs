        ...
        public static FileInfo ToHtml(string docxPath, string htmlPath)
        {
            ...
            using (MemoryStream memoryStream = new MemoryStream())
            {
                ...
                using (WordprocessingDocument wDoc = WordprocessingDocument.Open(memoryStream, true))
                {
                    ...
                    // Produce HTML document with <!DOCTYPE html > declaration to tell the browser we
                    // are using HTML5.
                    ...
                    // for detailed explanation. // If you further transform the XML tree returned by
                    // ConvertToHtmlTransform, you must do it correctly, or entities will not be
                    // serialized properly.
