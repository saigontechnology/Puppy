namespace TopCore.Framework.Search.Elastic
{
    ...
    public class ElasticSerializerConfiguration
    {
        ...
        /// <summary>
        ///   This defines idf you want to define your own routing. You should only do this if you know what you are doing or you have grandchild
        ///   documents in a parent child grandchild relationship. This makes certain that the grandchildren are defined on the same shard. It also
        ///   cuses that gets, etc required the routing value of the parent route document...
        /// </summary>
