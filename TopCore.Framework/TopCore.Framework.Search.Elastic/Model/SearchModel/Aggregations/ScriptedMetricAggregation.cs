...
namespace TopCore.Framework.Search.Elastic.Model.SearchModel.Aggregations
{
    ...
    public class ScriptedMetricAggregation : IAggs
    {
        ...
        /// <summary>
        ///   combine_script Executed once on each shard after document collection is complete. Allows the aggregation to consolidate the state
        ///   returned from each shard. If a combine_script is not provided the combine phase will return the aggregation variable.
        /// </summary>
        ...
        /// <summary>
        ///   reduce_script Executed once on the coordinating node after all shards have returned their results. The script is provided with access to
        ///   a variable _aggs which is an array of the result of the combine_script on each shard. If a reduce_script is not provided the reduce phase
        ///   will return the _aggs variable.
        /// </summary>
        ...
        /// <summary>
        ///   reduce_params Optional. An object whose contents will be passed as variables to the reduce_script. This can be useful to allow the user
        ///   to control the behavior of the reduce phase. If this is not specified the variable will be undefined in the reduce_script execution.
        /// </summary>
