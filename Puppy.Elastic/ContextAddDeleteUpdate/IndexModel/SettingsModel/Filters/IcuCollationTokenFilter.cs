...
namespace Puppy.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel.Filters
{
    public class IcuCollationTokenFilter : AnalysisFilterBase
    {
        ...
        /// <summary>
        ///     strength The strength property determines the minimum level of difference considered
        ...
        /// <summary>
        ///     decomposition Possible values: no or canonical. Defaults to no. Setting this
        ///     decomposition property with canonical allows the Collator to handle un-normalized
        ///     text properly, producing the same results as if the text were normalized. If no is
        ///     set, it is the user’s responsibility to insure that all text is already in the
        ///     appropriate form before a comparison or before getting a CollationKey. Adjusting
        ///     decomposition mode allows the user to select between faster and more complete
        ///     collation behavior. Since a great many of the world’s languages do not require text
        ...
        /// <summary>
        ///     alternate Possible values: shifted or non-ignorable. Sets the alternate handling for
        ///     strength quaternary to be either shifted or non-ignorable. What boils down to
        ...
        /// <summary>
        ///     caseLevel Possible values: true or false. Default is false. Whether case level
        ///     sorting is required. When strength is set to primary this will ignore accent differences.
        /// </summary>
        ...
        /// <summary>
        ///     caseFirst Possible values: lower or upper. Useful to control which case is sorted
        ///     first when case is not ignored for strength tertiary.
        /// </summary>
        ...
        /// <summary>
        ///     numeric Possible values: true or false. Whether digits are sorted according to
        ///     numeric representation. For example the value egg-9 is sorted before the value
        ///     egg-21. Defaults to false.
        /// </summary>
        public bool Numeric
        {
            get => _numeric;
        ...
        /// <summary>
        ///     hiraganaQuaternaryMode Possible values: true or false. Defaults to false.
