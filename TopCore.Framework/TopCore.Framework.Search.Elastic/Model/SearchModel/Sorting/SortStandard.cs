...
namespace TopCore.Framework.Search.Elastic.Model.SearchModel.Sorting
{
    public class SortStandard : ISort
    {
        ...
        ///   document it belongs to. The mode option can have the following values: SortMode enum: min, max, sum, avg
        /// </summary>
        ...
        /// <summary>
        ///   The missing parameter specifies how docs which are missing the field should be treated: The missing value can be set to _last, _first, or
        ///   a custom value (that will be used for missing docs as the sort value).
        /// </summary>
        ...
        /// <summary>
        ///   unmapped_type By default, the search request will fail if there is no mapping associated with a field. The unmapped_type option allows to
        ///   ignore fields that have no mapping and not sort by them. The value of this parameter is used to determine what sort values to emit. If
        ///   any of the indices that are queried doesn’t have a mapping for price then Elastic will handle it as if there was a mapping of type long,
