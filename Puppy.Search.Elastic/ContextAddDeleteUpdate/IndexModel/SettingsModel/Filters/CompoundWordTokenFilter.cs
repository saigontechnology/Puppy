...
namespace Puppy.Search.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel.Filters
{
    ...
    public abstract class CompoundWordTokenFilter : AnalysisFilterBase
    {
        ...
        /// <summary>
        ///     hyphenation_patterns_path A path (either relative to config location, or absolute) to
        ///     a FOP XML hyphenation pattern file. (See http://offo.sourceforge.net/hyphenation/)
