...
{
    /// <summary>
    ///     More like this query find documents that are "like" provided text by running it against
    ///     one or more fields. Additionally, More Like This can find documents that are "like" a set
    ///     of chosen documents. The syntax to specify one or more documents is similar to the Multi
    ///     GET API, and supports the ids or docs array. If only one document is specified, the query
    ///     behaves the same as the More Like This API. Under the hood, more_like_this simply creates
    ///     multiple should clauses in a bool query of interesting terms extracted from some provided
    ///     text. The interesting terms are selected with respect to their tf-idf scores. These are
    ///     controlled by min_term_freq, min_doc_freq, and max_doc_freq. The number of interesting
    ///     terms is controlled by max_query_terms. While the minimum number of clauses that must be
    ///     satisfied is controlled by percent_terms_to_match. The terms are extracted from like_text
    ///     which is analyzed by the analyzer associated with the field, unless specified by
    ///     analyzer. There are other parameters, such as min_word_length, max_word_length or
    ///     stop_words, to control what terms should be considered as interesting. In order to give
    ///     more weight to more interesting terms, each boolean clause associated with a term could
    ///     be boosted by the term tf-idf score times some boosting factor boost_terms. When a search
    ///     for multiple docs is issued, More Like This generates a more_like_this query per document
    ///     field in fields. These fields are specified as a top level parameter or within each doc.
    /// </summary>
    public class MoreLikeThisQuery : IQuery
    {
        ...
        /// <summary>
        ///     include When using ids or docs, specifies whether the documents should be included
        ///     from the search. Defaults to false.
        /// </summary>
        public bool Include
        {
            get => _include;
        ...
        /// <summary>
        ///     exclude When using ids or docs, specifies whether the documents should be excluded
        ///     from the search. Defaults to true.
        /// </summary>
        public bool Exclude
        {
            get => _exclude;
        ...
        /// <summary>
        ///     min_term_freq The frequency below which terms will be ignored in the source doc. The
        ...
        /// <summary>
        ///     max_query_terms The maximum number of query terms that will be included in any
        ...
        /// <summary>
        ///     stop_words An array of stop words. Any word in this set is considered "uninteresting"
        ///     and ignored. Even if your Analyzer allows stopwords, you might want to tell the
        ///     MoreLikeThis code to ignore them, as for the purposes of document similarity it seems
        ...
        /// <summary>
        ///     min_doc_freq The frequency at which words will be ignored which do not occur in at
        ...
        /// <summary>
        ///     max_doc_freq The maximum frequency in which words may still appear. Words that appear
        ...
        /// <summary>
        ///     min_word_length The minimum word length below which words will be ignored. Defaults
        ///     to 0.(Old name "min_word_len" is deprecated)
        /// </summary>
        ...
        /// <summary>
        ///     max_word_length The maximum word length above which words will be ignored. Defaults
        ///     to unbounded (0). (Old name "max_word_len" is deprecated)
        /// </summary>
        ...
        /// <summary>
        ///     boost_terms Sets the boost factor to use when boosting terms. Defaults to deactivated
        ///     (0). Any other value activates boosting with given boost factor.
        /// </summary>
