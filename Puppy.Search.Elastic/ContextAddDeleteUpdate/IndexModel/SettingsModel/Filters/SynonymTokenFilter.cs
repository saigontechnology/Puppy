...
namespace Puppy.Search.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel.Filters
{
    public class SynonymTokenFilter : AnalysisFilterBase
    {
        ...
        /// <summary>
        ///     The synonym token filter allows to easily handle synonyms during the analysis
        ///     process. Synonyms are configured using a configuration file. Additional settings are:
        ///     ignore_case (defaults to false), and expand (defaults to true). The tokenizer
        ///     parameter controls the tokenizers that will be used to tokenize the synonym, and
        ///     defaults to the whitespace tokenizer.
        /// </summary>
        ...
        /// <summary>
        ///     Two synonym formats are supported: Solr, WordNet. These can be defined directly with
        ///     this parameter.
        /// </summary>
