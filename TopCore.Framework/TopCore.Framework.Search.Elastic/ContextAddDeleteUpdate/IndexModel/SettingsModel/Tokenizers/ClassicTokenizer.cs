...
namespace TopCore.Framework.Search.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel.Tokenizers
{
    public class ClassicTokenizer : BaseTokenizer
    {
        ...
        ///     documents. This tokenizer has heuristics for special treatment of acronyms, company names, email addresses, and
        ///     internet host names. However, these rules don’t always work, and
