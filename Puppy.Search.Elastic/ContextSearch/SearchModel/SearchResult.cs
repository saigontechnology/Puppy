...
using Puppy.Search.Elastic.ContextSearch.SearchModel.AggModel;
using Puppy.Search.Elastic.Model;

namespace Puppy.Search.Elastic.ContextSearch.SearchModel
{
    // { "took":3, "timed_out":false, "_shards":{"total":5,"successful":5,"failed":0}, "hits":{
    // "total":1, "max_score":1.0, "hits":[{ "_index":"parentdocuments",
    // "_type":"childdocumentleveltwo", "_id":"35","_score":1.0,
