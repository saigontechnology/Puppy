...
//     <File>
//         <Name> RedirectToCanonicalUrlAttribute.cs </Name>
//         <Created> 07/06/2017 11:04:24 PM </Created>
//         <Key> 8ac0e9c3-316a-451d-a828-585e1231893d </Key>
//     </File>
//     <Summary>
//         RedirectToCanonicalUrlAttribute.cs
//     </Summary>
// <License>
//------------------------------------------------------------------------------------------------
#endregion License
...
{
    /// <summary>
    ///     To improve Search Engine Optimization SEO, there should only be a single URL for each
    ///     resource. Case differences and/or URL's with/without trailing slashes are treated as
    ///     different URL's by search engines. This filter redirects all non-canonical URL's based on
    ///     the settings specified to their canonical equivalent.
    ///     Note: Non-canonical URL's are not generated by this site template, it is usually external
    ///           sites which are linking to your site but have changed the URL case or added/removed
    ///     trailing slashes. (See Google's comments at
    ///     http://googlewebmastercentral.blogspot.co.uk/2010/04/to-slash-or-not-to-slash.html and
    ///     Bing's at http://blogs.bing.com/webmaster/2012/01/26/moving-content-think-301-not-relcanonical).
    /// </summary>
    ...
    public class RedirectToCanonicalUrlAttribute : System.Attribute, IResourceFilter
    {
        ...
        ///     Initializes a new instance of the <see cref="RedirectToCanonicalUrlAttribute" /> class. 
        /// </summary>
        /// <param name="appendTrailingSlash">
        ///     If set to <c> true </c> append trailing slashes, otherwise strip trailing slashes.
        /// </param>
        ...
        ///     pipeline. Determines whether the HTTP request contains a non-canonical URL using
        ///     <see cref="TryGetCanonicalUrl" />, if it doesn't calls the
        ///     <see cref="HandleNonCanonicalRequest" /> method.
        /// </summary>
        ...
        /// <summary>
        ///     Determines whether the specified URl is canonical and if it is not, outputs the
        ///     canonical URL.
        /// </summary>
        /// <param name="context">      The <see cref="T:Microsoft.AspNetCore.Mvc.Filters.ResourceExecutingContext" />. </param>
        ...
        protected virtual bool TryGetCanonicalUrl(ResourceExecutingContext context, out string canonicalUrl)
        {
            ...
            // If we are not dealing with the home page. Note, the home page is a special case and it
            // doesn't matter if there is a trailing slash or not. Both will be treated as the same
            // by search engines.
        ...
        /// <summary>
        ///     Handles HTTP requests for URL's that are not canonical. Performs a 301 Permanent
        ...
        /// <summary>
        ///     Determines whether the specified action or its controller has the attribute with the
        ///     specified type <typeparamref name="T" />.
        /// </summary>
        /// <typeparam name="T"> The type of the attribute. </typeparam>
        /// <param name="context"> The <see cref="T:Microsoft.AspNetCore.Mvc.Filters.ResourceExecutingContext" />. </param>
        /// <returns>
        ///     <c> true </c> if a <typeparamref name="T" /> attribute is specified, otherwise <c>
        ///     false </c>.
        /// </returns>
