...
namespace TopCore.Framework.Search.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel.Filters
{
    public class IcuCollationTokenFilter : AnalysisFilterBase
    {
        ...
        /// <summary>
        ///   strength The strength property determines the minimum level of difference considered significant during comparison. The default strength
        ///   for the Collator is tertiary, unless specified otherwise by the locale used to create the Collator. Possible values: primary, secondary,
        ///   tertiary, quaternary or identical. See ICU Collation documentation for a more detailed explanation for the specific values.
        /// </summary>
        ...
        /// <summary>
        ///   decomposition Possible values: no or canonical. Defaults to no. Setting this decomposition property with canonical allows the Collator to
        ///   handle un-normalized text properly, producing the same results as if the text were normalized. If no is set, it is the user’s
        ///   responsibility to insure that all text is already in the appropriate form before a comparison or before getting a CollationKey. Adjusting
        ///   decomposition mode allows the user to select between faster and more complete collation behavior. Since a great many of the world’s
        ///   languages do not require text normalization, most locales set no as the default decomposition mode.
        /// </summary>
        ...
        /// <summary>
        ///   alternate Possible values: shifted or non-ignorable. Sets the alternate handling for strength quaternary to be either shifted or
        ///   non-ignorable. What boils down to ignoring punctuation and whitespace.
        /// </summary>
        ...
        /// <summary>
        ///   caseLevel Possible values: true or false. Default is false. Whether case level sorting is required. When strength is set to primary this
        ///   will ignore accent differences.
        /// </summary>
        ...
        /// <summary>
        ///   numeric Possible values: true or false. Whether digits are sorted according to numeric representation. For example the value egg-9 is
        ///   sorted before the value egg-21. Defaults to false.
        /// </summary>
        public bool Numeric
        {
            get => _numeric;
        ...
        /// <summary>
        ///   hiraganaQuaternaryMode Possible values: true or false. Defaults to false. Distinguishing between Katakana and Hiragana characters in
        ///   quaternary strength .
        /// </summary>
