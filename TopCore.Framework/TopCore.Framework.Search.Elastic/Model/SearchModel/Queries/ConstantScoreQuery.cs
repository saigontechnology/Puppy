...
namespace TopCore.Framework.Search.Elastic.Model.SearchModel.Queries
{
    ...
    ///   Maps to Lucene ConstantScoreQuery. The filter object can hold only filter elements, not queries. Filters can be much faster compared to
    ///   queries since they don’t perform any scoring, especially when they are cached.
    /// </summary>
