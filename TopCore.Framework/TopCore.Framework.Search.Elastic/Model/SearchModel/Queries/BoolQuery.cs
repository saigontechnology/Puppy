...
namespace TopCore.Framework.Search.Elastic.Model.SearchModel.Queries
{
    ...
    ///   "details" : "data" } }, { "term" : { "details" : "alone" } } ], "minimum_should_match" : 1, "boost" : 3.0 } } }
    /// </summary>
    public class BoolQuery : IQuery
    {
        ...
        /// <summary>
        ///   disable_coord The bool query also supports disable_coord parameter (defaults to false). Basically the coord similarity computes a score
