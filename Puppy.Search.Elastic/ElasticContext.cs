...
using Puppy.Search.Elastic.ContentExists;
using Puppy.Search.Elastic.ContextAddDeleteUpdate;
...
using Puppy.Search.Elastic.ContextAlias;
using Puppy.Search.Elastic.ContextAlias.AliasModel;
using Puppy.Search.Elastic.ContextClearCache;
using Puppy.Search.Elastic.ContextCount;
using Puppy.Search.Elastic.ContextDeleteByQuery;
using Puppy.Search.Elastic.ContextGet;
using Puppy.Search.Elastic.ContextSearch;
using Puppy.Search.Elastic.ContextSearch.SearchModel;
using Puppy.Search.Elastic.ContextWarmers;
...
namespace Puppy.Search.Elastic
{
    ...
    public class ElasticContext : IDisposable
    {
        ...
        ///     Connection string which is used as ther base URL for the HttpClient
        /// </param>
            ...
            NetworkCredential credentials = null)
        {
            ...
            TraceProvider.Trace(TraceEventType.Verbose, "{1}: new ElasticContext with connection string: {0}",
                connectionString, "ElasticContext");
            InitialContext();
        }
        ...
        /// <summary>
        ///     Adds a document to the pending changes list to be deletedd. Nor HTTP request is sent
        ...
        public ResultDetails<OptimizeResult> IndexOptimize(string index = null,
        ...
        /// <param name="index">              
        ///     index to be updated, if null, updatesa all indices
        /// </param>
        ...
        ///     may still recieve the child document (parentId might be saved to the same shard.) If
        ///     the child is a child document and no parent id is set, no docuemnt will be found.
        /// </param>
        ...
        /// <param name="routing"> routing used for the search </param>
        /// <returns> true if one document exists for the search query </returns>
        public async Task<ResultDetails<bool>> SearchExistsAsync<T>(Model.SearchModel.Search search,
            string routing = null)
        {
            SearchUrlParameters searchUrlParameters = null;
            if (!string.IsNullOrEmpty(routing))
        ...
        /// </returns>
        public ResultDetails<SearchResult<T>> SearchCreateScanAndScroll<T>(string jsonContent,
            ScanAndScrollConfiguration scanAndScrollConfiguration)
        {
        ...
        ///     Returns the _scroll_id in the Payload property and the total number of hits.
        /// </returns>
        public ResultDetails<SearchResult<T>> SearchCreateScanAndScroll<T>(Model.SearchModel.Search search,
            ScanAndScrollConfiguration scanAndScrollConfiguration)
        {
        ...
        ///     Returns the _scroll_id in the Payload property and the total number of hits.
        /// </returns>
        public async Task<ResultDetails<SearchResult<T>>> SearchCreateScanAndScrollAsync<T>(string jsonContent,
            ScanAndScrollConfiguration scanAndScrollConfiguration)
        {
        ...
        ///     Returns the _scroll_id in the Payload property and the total number of hits.
        /// </returns>
        public async Task<ResultDetails<SearchResult<T>>> SearchCreateScanAndScrollAsync<T>(
