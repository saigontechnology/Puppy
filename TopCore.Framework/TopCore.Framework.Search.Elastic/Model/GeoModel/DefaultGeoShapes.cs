namespace TopCore.Framework.Search.Elastic.Model.GeoModel
{
    public class DefaultGeoShapes
    {
        ...
        /// <summary>
        ///     A closed polygon whose first and last point must match, thus requiring n + 1 vertices to create an n-sided polygon
        ///     and a minimum of 4 vertices.
        /// </summary>
        ...
        /// <summary>
        ///     A GeoJSON shape similar to the multi* shapes except that multiple types can coexist (e.g., a Point and a
        ///     LineString).
        /// </summary>
