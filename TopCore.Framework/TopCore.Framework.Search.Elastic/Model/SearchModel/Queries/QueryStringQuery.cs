...
namespace TopCore.Framework.Search.Elastic.Model.SearchModel.Queries
{
    ...
    public class QueryStringQuery : IQuery
    {
        ...
        /// <summary>
        ///     default_field The default field for query terms if no prefix field is specified. Defaults to the index.query.default_field index settings, which in turn defaults to _all. When not explicitly specifying the field to search on in the query string syntax, the index.query. default_field
        ///     will be used to derive which field to search on. It defaults to _all field. So, if _all field is disabled, it might make sense to change it to set a different default fie
        /// </summary>
