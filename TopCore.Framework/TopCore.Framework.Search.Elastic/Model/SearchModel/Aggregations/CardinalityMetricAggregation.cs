...
namespace TopCore.Framework.Search.Elastic.Model.SearchModel.Aggregations
{
    ...
    public class CardinalityMetricAggregation : BaseMetricAggregation
    {
        ...
        /// <summary>
        ///     The precision_threshold options allows to trade memory for accuracy, and defines a unique count below which counts are expected to be close to accurate. Above this value, counts might become a bit more fuzzy. The maximum supported value is 40000, thresholds above this number will have
        ///     the same effect as a threshold of 40000. Default value depends on the number of parent aggregations that multiple create buckets (such as terms or histograms).
        /// </summary>
        ...
        /// <summary>
        ///     If you computed a hash on client-side, stored it into your documents and want Elastic to use them to compute counts using this hash function without rehashing values, it is possible to specify rehash: false. Default value is true. Please note that the hash must be indexed as a long
        ///     when rehash is false.
        /// </summary>
        public bool Rehash
        {
            get => _rehash;
