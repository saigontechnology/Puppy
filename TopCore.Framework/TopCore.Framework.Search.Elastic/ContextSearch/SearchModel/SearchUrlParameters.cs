...
{
    /// <summary>
    ///     This class is used to set routing or pretty search for the url parameters. All other options can be sent in the
    ///     body
    /// </summary>
    public class SearchUrlParameters
    {
        ...
        /// <summary>
        ///     search_type The type of the search operation to perform. Can be dfs_query_then_fetch, dfs_query_and_fetch,
        ///     query_then_fetch, query_and_fetch. Defaults to query_then_fetch. See Search Type for more. count and scan
        /// </summary>
        ...
        /// <summary>
        ///     query_cache [1.4.0.Beta1] Added in 1.4.0.Beta1. Set to true or false to enable or disable the caching of search
        ///     results for requests where ?search_type=count, ie aggregations and suggestions. See Shard query cache.
        /// </summary>
