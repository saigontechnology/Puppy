...
{
    /// <summary>
    ///     Scripts are compiled and cached for faster execution. If the same script can be used,
    ///     just with different parameters provider, it is preferable to use the ability to pass
    ///     parameters to the script itself
    /// </summary>
