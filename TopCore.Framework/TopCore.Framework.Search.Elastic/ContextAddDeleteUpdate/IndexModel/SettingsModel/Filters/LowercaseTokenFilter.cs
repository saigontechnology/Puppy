...
namespace TopCore.Framework.Search.Elastic.ContextAddDeleteUpdate.IndexModel.SettingsModel.Filters
{
    public class LowercaseTokenFilter : AnalysisFilterBase
    {
        ...
        /// <summary>
        ///     A token filter of type lowercase that normalizes token text to lower case. Lowercase token filter supports Greek,
        ///     Irish, and Turkish lowercase token filters through the language parameter.
        /// </summary>
