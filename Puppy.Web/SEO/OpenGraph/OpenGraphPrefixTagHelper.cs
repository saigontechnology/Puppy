...
namespace Puppy.Web.SEO.OpenGraph
{
    /// <summary>
    ///     Adds the open graph prefix attribute to the head tag. The prefix is different depending
    ///     on the type of open graph object being used.
    /// </summary>
    ...
    public class OpenGraphPrefixTagHelper : TagHelper
    {
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether this <see cref="OpenGraphPrefixTagHelper" />
        ///     is enabled.
        /// </summary>
        ...
        ///     <see cref="M:Microsoft.AspNetCore.Razor.TagHelpers.TagHelper.Process(Microsoft.AspNetCore.Razor.TagHelpers.TagHelperContext,Microsoft.AspNetCore.Razor.TagHelpers.TagHelperOutput)" /> .
        /// </remarks>
        /// .
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            if (Enabled)
            {
                ...
                // if (context.Items.ContainsKey(typeof(OpenGraphMetadata))) { string namespaces =
                // context.Items[typeof(OpenGraphMetadata)] as string;
                // output.Attributes.Add(PrefixAttributeName, namespaces); }
            }
        }
    }
